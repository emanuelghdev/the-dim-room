...
class MyPuerta extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    (object) => {
      ...
      object.children[0].removeFromParent();  // Quitamos el marco de la puerta, para meterlo en la escena aparta
                                              // de forma que podramos girar la puerta sin girar el marco
